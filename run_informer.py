...
def build_model(spec):
    ...
    return InformerWrapper(
        ...
        d_model=h["informer_d_model"],
        n_heads=h["informer_n_heads"],
        e_layers=h["informer_e_layers"],
        d_layers=h["informer_d_layers"],
        d_ff=h["informer_d_ff"],
        factor=h["informer_factor"],
        dropout=h["informer_dropout"],
        embed=h["informer_embed"],
        freq=h["informer_freq"],
        distil=h["informer_distil"],
    )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Informer final protocol")
