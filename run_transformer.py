...
def build_model(spec):
    ...
    return TransformerWrapper(
        ...
        d_model=h["trans_d_model"],
        n_heads=h["trans_n_heads"],
        e_layers=h["trans_e_layers"],
        d_layers=h["trans_d_layers"],
        d_ff=h["trans_d_ff"],
        dropout=h["trans_dropout"],
        activation=h["trans_activation"],
        factor=h["trans_factor"],
    )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run Transformer final protocol")
